...
These data have been collected with a GPS. Every twenty seconds the GPS collects a ranging point, which is a set of data that contains, among others, the x and y coordinates for the location, altitude of the location, and a timestamp. From that, we (read: Tony) have created a .csv file that contains a subset of these points, twenty minutes apart.
